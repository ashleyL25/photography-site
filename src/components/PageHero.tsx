    ...
    <section className="relative isolate overflow-hidden">
      ...
      <div className="shell pt-40 pb-20 text-beige md:pt-52 md:pb-28 print:pt-0 print:pb-6 print:text-ink">
        ...
        <MaskText
          as="h1"
          text={heading}
          className="display mt-8 max-w-4xl text-[clamp(2.8rem,8vw,6.5rem)] text-beige print:text-[2.4rem] print:text-ink"
        />
        ...
        {body && (
          <Reveal
            delay={0.15}
            as="p"
            className="mt-8 max-w-xl leading-[1.85] text-beige/75 print:text-muted"
          >
            {body}
          </Reveal>
        )}
